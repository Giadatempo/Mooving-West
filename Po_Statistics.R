...
setwd("D:/TESI_GIADA/Giada/RIPROIETTATO/PO")
...
CCost_aid_ani <- raster("Cost_map/river_anisotropic/Po_basin_cumulative.tif")
no_riv <- raster("Cost_map/no_river/no_riv_cumulative_cost_map.tif")
Krig <- raster("Kriging/Po_UniKriging.tif")
...
Stream_dist4 <- raster("distance_matrix_Po_Strahler_4.tif", proj4string = crs.reg)
Stream_dist6 <- raster("distance_matrix_Po_Strahler_6.tif", proj4string = crs.reg)
